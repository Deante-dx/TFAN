...
class H36MDataset(data.Dataset):
    def __init__(self, config, split_name, data_aug=False):
        ...
        self.used_joint_indexes = np.array([0, 1, 6, 2,3,4,5,7,8,9,10,12,13,14,15,17,18,19,21,22,25,26,27,29,30]).astype(np.int64)
